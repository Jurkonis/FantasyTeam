...
namespace FLTeam.Tests
{
	...
	public class UsersController : ControllerBase
	{
		...
		public UsersController(FakeDbContext context, IUserRepository userRepository)
		{
			_context = context;
		...
		public async Task<ActionResult> PostUser(Login user)
		{
			...
			_context.User.Add(new User { Username = user.Username, Password = PasswordHandler.CreatePasswordHash( user.Password) });
			await _context.SaveChangesAsync();
